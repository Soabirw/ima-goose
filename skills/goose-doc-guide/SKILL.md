...
This skill is ported verbatim from Goose's builtin skill (`goose_doc_guide.md`, compiled into `/home/eric/.local/bin/goose`). Update if Goose upstream changes the skill.
